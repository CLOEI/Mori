  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <ScrollArea className="flex-1 min-h-0">
        <div className="p-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-4">
          {data?.items.map((item) => (
            <div
              key={item.id}
              className="p-3 border rounded bg-card hover:shadow-md transition-shadow"
            >
